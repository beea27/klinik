...
<html lang="pt-br">
    ...
    <body id="page-top">
        ...
        <!-- Contact-->
        <section class="page-section cad_paciente" id="contact" style="background-color:#fff">
            <div class="container">
                <div class="text-center">
                    <h2 class="section-heading text-uppercase">Cadastro de Paciente</h2>
                </div>
                <form id="contactForm"  action="php/insere_paciente.php" method="post">
                    <div class="row align-items-stretch mb-5">
                        ...
                        <div class="col-md-5">
                            <div class="form-group">
                                <input class="form-control" id="name" name="nome" type="text" placeholder="Nome *" required="required" data-validation-required-message="Insira seu nome." />  
                            </div>
                            <div class="form-group">
                            ...
                            <div class="form-group">
                                <input class="form-control" id="dt_nasc" name="dt_nasc" type="date" placeholder="Data de Nascimento *" required="required" data-validation-required-message="Insira o CPF." /> 
                            </div>
                            <div class="form-group">
                                <select class="form-control" id="sexo" name="sexo" placeholder="Sexo *" required="required" data-validation-required-message="Insira o sexo.">
                                    <option>Sexo...</option>
                            ...
                            <div class="form-group">
                                <select class="form-control" id="convenio" name="convenio" max-length="14"  placeholder="convenio *" required="required">
                                    <option>Convevio...</option>
